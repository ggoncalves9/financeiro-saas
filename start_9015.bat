@echo off
title Servidor Laravel - Porta 9015 (Acesso Total)
color 0A
echo.
echo ================================================
echo        INICIANDO SERVIDOR LARAVEL
echo        Projeto: Financeiro SaaS
echo        Porta: 9015 (Acesso Local e Externo)
echo ================================================
echo.
...
%PHP_CMD% artisan view:clear >nul 2>nul

echo [INFO] Verificando conexao com banco de dados...
%PHP_CMD% artisan migrate:status >nul 2>nul
if %errorlevel% neq 0 (
    echo [AVISO] Problema com banco de dados. Continuando...
)
...
echo   
echo   Acesso Local: http://localhost:9015
echo   Acesso Local IP: http://127.0.0.1:9015
echo   Acesso Externo: http://189.46.172.45:9015
echo   
...
echo ================================================
echo.
echo [INFO] Servidor configurado para acesso externo
echo [INFO] Certifique-se que a porta 9015 esta liberada no firewall
echo.
