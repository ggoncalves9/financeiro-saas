                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="card text-center bg-success text-white">
                            <div class="card-body">
                                <h5>R$ {{ $summary['paid_formatted'] }}</h5>
                    ...
                    <div class="col-md-3">
                        <div class="card text-center bg-warning">
                            <div class="card-body">
                                <h5>R$ {{ $summary['pending_formatted'] }}</h5>
                    ...
                    <div class="col-md-3">
                        <div class="card text-center bg-danger text-white">
                            <div class="card-body">
                                <h5>R$ {{ $summary['overdue_formatted'] }}</h5>
                    ...
                    <div class="col-md-3">
                        <div class="card text-center bg-info text-white">
                            <div class="card-body">
                                <h5>R$ {{ $summary['total_formatted'] }}</h5>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-danger fw-bold">R$ {{ number_format($expense->amount, 2, ',', '.') }}</td>
                                            <td>{{ $expense->date->format('d/m/Y') }}</td>
                                            <td>{{ $expense->due_date ? $expense->due_date->format('d/m/Y') : '-' }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('expenses.show', $expense) }}" class="btn btn-sm btn-outline-primary" title="Ver">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('expenses.edit', $expense) }}" class="btn btn-sm btn-outline-warning" title="Editar">
                        ...
                        <div class="row text-center">
                            <div class="col-12 mb-3">
                                <div class="border-bottom pb-2">
                                    <h5 class="text-primary">{{ $summary['monthly_average_formatted'] }}</h5>
