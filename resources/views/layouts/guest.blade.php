...
<head>
    ...
    <title>{{ config('app.name', 'Financeiro SaaS') }} - @yield('title', 'Sistema Financeiro')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent position-absolute w-100" style="z-index: 1000;">
        <div class="container">
            <a class="navbar-brand text-white" href="{{ route('home') }}">
                ...
                {{ config('app.name', 'Financeiro SaaS') }}
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                    <li class="nav-item">
                        <a class="btn btn-light ms-2" href="{{ route('dashboard') }}">Dashboard</a>
                    </li>
                    @endauth
                </ul>
            </div>
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>{{ config('app.name', 'Financeiro SaaS') }}</h5>
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <p class="mt-2 mb-0 text-muted">&copy; {{ date('Y') }} Todos os direitos reservados.</p>
                </div>
            </div>
        </div>
    </footer>
