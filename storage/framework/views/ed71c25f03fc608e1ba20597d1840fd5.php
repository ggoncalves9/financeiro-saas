...
<div class="quick-actions">
    ...
    <a href="<?php echo e(route('goals.create')); ?>" class="quick-action-btn primary">
        <i class="fas fa-bullseye fa-2x"></i>
        <span>Nova Meta</span>
    </a>
    <a href="<?php echo e(route('accounts.create')); ?>" class="quick-action-btn info">
        ...
        <div class="kpi-card">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                    ...
                    <div class="kpi-value text-success"><?php echo e($formatted_monthly_revenues ?? 'R$ 0,00'); ?></div>
                </div>
        ...
        <div class="kpi-card">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                    ...
                    <div class="kpi-value text-danger"><?php echo e($formatted_monthly_expenses ?? 'R$ 0,00'); ?></div>
                </div>
        ...
        <div class="kpi-card">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                    ...
                    <div class="kpi-value <?php echo e(($monthly_balance ?? 0) >= 0 ? 'text-success' : 'text-danger'); ?>">
                        <?php echo e($formatted_monthly_balance ?? 'R$ 0,00'); ?>
            ...
            <div class="kpi-change <?php echo e(($monthly_balance ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                <i class="fas fa-arrow-<?php echo e(($monthly_balance ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                <span><?php echo e(($monthly_balance ?? 0) >= 0 ? 'Situação positiva' : 'Atenção necessária'); ?></span>
            </div>
        </div>
    </div>
        ...
        <div class="kpi-card">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                    ...
                    <div class="kpi-value text-primary"><?php echo e($goals_achieved ?? 0); ?>/<?php echo e($total_goals ?? 0); ?></div>
                </div>
            ...
            <div class="kpi-change positive">
                ...
                <span><?php echo e($goals_completion_rate ?? 0); ?>% de conclusão</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card h-100">
            <div class="card-header border-0 bg-transparent">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('goals.index')); ?>" class="btn btn-sm btn-outline-primary">Ver todas</a>
                </div>
            </div>
            <div class="card-body">
                <?php if($goals->count() > 0): ?>
                    <?php $__currentLoopData = $goals->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="fw-medium"><?php echo e($goal->title); ?></span>
                            <span class="text-primary fw-bold"><?php echo e($goal->progress_percentage); ?>%</span>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-gradient" role="progressbar" 
                                 style="width: <?php echo e($goal->progress_percentage); ?>%; background: linear-gradient(90deg, #6366f1, #06b6d4);"></div>
                        </div>
                        <div class="d-flex justify-content-between mt-1">
                            <small class="text-muted"><?php echo e($goal->current_amount ?? 'R$ 0'); ?></small>
                            <small class="text-muted"><?php echo e($goal->target_amount ?? 'R$ 0'); ?></small>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    <div class="text-center text-muted py-5">
                        ...
                        <a href="<?php echo e(route('goals.create')); ?>" class="btn btn-primary btn-sm">
        ...
        <div class="card h-100">
            <div class="card-header border-0 bg-transparent">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('expenses.index')); ?>" class="btn btn-sm btn-outline-primary">Ver todas</a>
                </div>
            </div>
            <div class="card-body">
                <?php if($recent_expenses->count() > 0): ?>
                    <?php $__currentLoopData = $recent_expenses->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex justify-content-between align-items-center py-3 border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="fw-medium"><?php echo e($expense->title); ?></div>
                                <small class="text-muted"><?php echo e($expense->date->format('d/m/Y')); ?> • <?php echo e($expense->category); ?></small>
                            </div>
                        </div>
                        <div class="text-end">
                            <div class="text-danger fw-bold"><?php echo e($expense->formatted_amount); ?></div>
...
<?php if(isset($upcoming_expenses) && $upcoming_expenses->count() > 0): ?>
<div class="row mt-4">
    <div class="col-12">
        <div class="alert alert-warning border-0" style="background: linear-gradient(135deg, rgba(245, 158, 11, 0.1), rgba(245, 158, 11, 0.05));">
            <div class="d-flex align-items-start">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $upcoming_expenses->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                            <div class="small">
                                <strong><?php echo e($expense->title); ?></strong><br>
                                Vencimento: <?php echo e($expense->due_date->format('d/m/Y')); ?><br>
                                Valor: <?php echo e($expense->formatted_amount); ?>

                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php if($upcoming_expenses->count() > 3): ?>
                    <a href="<?php echo e(route('expenses.index', ['status' => 'pending'])); ?>" class="btn btn-warning btn-sm mt-2">
                        Ver todas (<?php echo e($upcoming_expenses->count()); ?>)
                    </a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php if(isset($overdue_expenses) && $overdue_expenses > 0): ?>
<div class="row">
    <div class="col-12">
        <div class="alert alert-danger border-0" style="background: linear-gradient(135deg, rgba(239, 68, 68, 0.1), rgba(239, 68, 68, 0.05));">
            <div class="d-flex align-items-start">
                ...
                <div>
                    ...
                    <p class="mb-2">Você tem <?php echo e($overdue_expenses); ?> despesa(s) em atraso.</p>
                    <a href="<?php echo e(route('expenses.index', ['overdue' => 1])); ?>" class="btn btn-danger btn-sm">
                        Resolver pendências
                    </a>
                </div>
            </div>
...
var goalsData = <?php echo json_encode($goals_chart_data); ?>;
var expenseCategories = <?php echo json_encode($expense_categories); ?>;
var revenueCategories = <?php echo json_encode($revenue_categories); ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('quickRevenueForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("revenues.quick-store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    document.getElementById('quickExpenseForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("expenses.quick-store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php echo $__env->make('layouts.uno-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/financeiro-saas/resources/views/dashboard/index.blade.php ENDPATH**/ ?>